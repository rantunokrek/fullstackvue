			...
			<div class="container-fluid">
				...
				<Modal v-model="addModal" title="Add role" :mask-closable="false" :closable="false">
					...
					<div slot="footer">
						...
						<Button type="primary" @click="add" :disabled="isAdding" :loading="isAdding">{{ isAdding ?
							'Adding..' : 'Add Role' }}</Button>
					</div>
				...
				<Modal v-model="editModal" title="Edit role" :mask-closable="false" :closable="false">
					...
					<div slot="footer">
						...
						<Button type="primary" @click="edit" :disabled="isAdding" :loading="isAdding">{{ isAdding ?
							'Editing..' : 'Edit Role' }}</Button>
					</div>
